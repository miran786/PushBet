...
import {
  ...
  useSetupScreen,
  wideModalMaxHeight
} from "./chunk-KGEU63A6.js";
import "./chunk-ULWIO5R3.js";
import {
  linkProfile
} from "./chunk-B4F2BT5K.js";
import "./chunk-TYCBL2ZK.js";
import {
  Spinner,
  WalletUIStatesProvider
} from "./chunk-52HWWTUR.js";
import {
  Button,
  ButtonLink,
  CheckCircledIcon,
...
import {
  isInAppWallet
} from "./chunk-RRMQWE7N.js";
import "./chunk-NXYVQ6IK.js";
import {
  getInjectedProvider
...
import {
  isSmartWallet
} from "./chunk-W6XYCZ2I.js";
import "./chunk-2X73OXBY.js";
import "./chunk-6GNRVNAL.js";
import {
  trackPayEvent
...
} from "./chunk-ZOAFHTRD.js";
import {
  sendAndConfirmTransaction
} from "./chunk-6ZAOKXRX.js";
import "./chunk-4SWHQGAJ.js";
import "./chunk-7CPZEEZI.js";
import "./chunk-TU26PSEE.js";
import "./chunk-KWFU4VSS.js";
import {
  once,
  prepareContractCall
} from "./chunk-S4O4COAW.js";
import {
  eth_blockNumber,
  waitForReceipt,
  watchBlockNumber
...
async function sendCalls(options) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-LUU7VETR.js");
...
async function getCallsStatus({ wallet, client, bundleId }) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-LUU7VETR.js");
...
function ClaimButton(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(TransactionButton, { payModal: {
    ...
    const [claimTx, { getApprovalForTransaction }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-SJ7XD6MQ.js")
    ]);
...
async function getERC721ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-M3Q2P2YT.js");
  return claimTo({
    contract,
...
async function getERC1155ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-C3JU4YAZ.js");
  return claimTo({
    contract,
    to: claimParams.to || (account == null ? void 0 : account.address) || "",
    quantity: claimParams.quantity,
...
async function getERC20ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-6QGZEKHH.js");
...
function BuyDirectListingButton(props) {
  ...
  const prepareBuyTransaction = (0, import_react12.useCallback)(async () => {
    ...
    const [listing, { getApprovalForTransaction }, { buyFromListing }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-SJ7XD6MQ.js"),
      import("./buyFromListing-BXO63VB5.js")
    ]);
    if (!listing) {
  ...
  const prepareTransaction = (0, import_react13.useCallback)(async () => {
    ...
    if (is1155) {
      const [{ isApprovedForAll }, { setApprovalForAll }] = await Promise.all([
        ...
        import("./setApprovalForAll-QO5IDFY6.js")
      ]);
      ...
      const [{ isApprovedForAll }, { setApprovalForAll }, { getApproved }] = await Promise.all([
        ...
        import("./setApprovalForAll-OMGJVS53.js"),
