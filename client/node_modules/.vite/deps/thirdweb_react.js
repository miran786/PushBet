import {
  getListing
} from "./chunk-GWGN6A3T.js";
import {
  getContractMetadata
} from "./chunk-7ZXXNJAJ.js";
import {
  AutoConnect,
  Blobbie,
  BuyScreen,
...
} from "./chunk-EMLAORUT.js";
import {
  isERC1155,
  isERC721
} from "./chunk-KYIAIDMK.js";
import "./chunk-MHIQAK6A.js";
import "./chunk-F5HF33T7.js";
import "./chunk-DJT7EXZK.js";
import "./chunk-LRCXVVXL.js";
import "./chunk-44IMCZ65.js";
import "./chunk-Y4PNJWU5.js";
import "./chunk-ALJAFMME.js";
import "./chunk-7MEI5NPB.js";
import {
  AccentFailIcon,
  getDefaultWallets
} from "./chunk-P3SCZKEX.js";
import {
  LoadingScreen,
  ...
  useSetupScreen,
  wideModalMaxHeight
} from "./chunk-EJRRYHJ3.js";
import "./chunk-ARW6RUHX.js";
import "./chunk-JTNHRXK5.js";
import {
  Spinner,
  WalletUIStatesProvider
} from "./chunk-IKSQLCUS.js";
import "./chunk-MJ254DAK.js";
import {
  Button,
  ButtonLink,
  CheckCircledIcon,
  ...
  useWalletImage,
  useWalletInfo
} from "./chunk-IPH4MP7T.js";
import {
  linkProfile
} from "./chunk-OEJONY6K.js";
import {
  getNFT
} from "./chunk-2RNEYUDQ.js";
import {
  getNFT as getNFT2
} from "./chunk-HHGC5IAE.js";
import "./chunk-3ZU326BB.js";
import "./chunk-YEMG74SH.js";
import "./chunk-KKKDFV63.js";
import "./chunk-STS64NGI.js";
import "./chunk-F5JWTEPP.js";
import "./chunk-NBJOJEZ3.js";
import {
  isWalletConnect
} from "./chunk-S2CPLKJK.js";
import "./chunk-3FEINVDM.js";
import "./chunk-67YIWUOQ.js";
import "./chunk-GMEVX4OR.js";
import {
  isEcosystemWallet
} from "./chunk-YXWTIL43.js";
import {
  getInjectedProvider
} from "./chunk-DMKTF64P.js";
import {
  isSmartWallet
} from "./chunk-HSM6D2XA.js";
import "./chunk-7LSLP65U.js";
import "./chunk-UGDCFS5N.js";
import "./chunk-6XGXFIVY.js";
import {
  isInAppWallet
} from "./chunk-ITVX3IKF.js";
import "./chunk-7FTIF2QJ.js";
import {
  trackPayEvent
} from "./chunk-UTANE6EG.js";
import "./chunk-NHH5L32Z.js";
import "./chunk-N7RQUMCX.js";
import "./chunk-R7LNV6W6.js";
import {
  isCoinbaseSDKWallet
} from "./chunk-PGN6RBK6.js";
...
import "./chunk-OGP6JCES.js";
import "./chunk-OP7OURTB.js";
import "./chunk-EV34OHXE.js";
import "./chunk-FTGVVEWF.js";
import "./chunk-MXVFSBJH.js";
...
} from "./chunk-VS72QB5O.js";
import {
  sendAndConfirmTransaction
} from "./chunk-RLYHT56Q.js";
import "./chunk-4SWHQGAJ.js";
import "./chunk-7CPZEEZI.js";
import "./chunk-NXXXBHC6.js";
import "./chunk-HF3GN5FC.js";
import {
  once,
  prepareContractCall
} from "./chunk-2SYFNEBS.js";
...
import {
  ...
  waitForReceipt,
  watchBlockNumber
} from "./chunk-MH77R3GN.js";
import "./chunk-QWTK625L.js";
import {
  sendTransaction
} from "./chunk-DS7S2O36.js";
import {
  estimateGas,
  getGasPrice
} from "./chunk-V3N5UI3F.js";
import {
...
import "./chunk-LN5L3RMI.js";
import "./chunk-J75GJCYK.js";
import "./chunk-LRNQZI6R.js";
import "./chunk-SP4JNVVX.js";
import "./chunk-YLMORAFS.js";
import {
  getClientFetch
} from "./chunk-HRZHMJXM.js";
...
async function getCapabilities({ wallet }) {
  ...
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletGetCapabilities } = await import("./coinbaseWebSDK-S7RSPYZ7.js");
...
async function sendCalls(options) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-P6KYSI5C.js");
  ...
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletSendCalls } = await import("./coinbaseWebSDK-S7RSPYZ7.js");
...
async function getCallsStatus({ wallet, client, bundleId }) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-P6KYSI5C.js");
    return inAppWalletGetCallsStatus({ wallet, client, bundleId });
  }
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletGetCallsStatus } = await import("./coinbaseWebSDK-S7RSPYZ7.js");
...
function ClaimButton(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(TransactionButton, { payModal: {
    ...
    const [claimTx, { getApprovalForTransaction }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-L6GLI374.js")
    ]);
...
async function getERC721ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-XJK4FSLH.js");
  return claimTo({
    contract,
...
async function getERC1155ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-WHR7SKLT.js");
  return claimTo({
    contract,
    to: claimParams.to || (account == null ? void 0 : account.address) || "",
    quantity: claimParams.quantity,
...
async function getERC20ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-VPLS3BRW.js");
...
function BuyDirectListingButton(props) {
  ...
  const prepareBuyTransaction = (0, import_react12.useCallback)(async () => {
    ...
    const [listing, { getApprovalForTransaction }, { buyFromListing }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-L6GLI374.js"),
      import("./buyFromListing-4UF4TZBT.js")
    ]);
    if (!listing) {
    ...
    asyncParams: async () => {
      ...
      if ("pricePerToken" in options) {
        if (isNativeTokenAddress(currencyAddress)) {
          ...
          const { decimals } = await import("./decimals-SD7S2YJ7.js");
  ...
  const prepareTransaction = (0, import_react13.useCallback)(async () => {
    ...
    if (is1155) {
      const [{ isApprovedForAll }, { setApprovalForAll }] = await Promise.all([
        import("./isApprovedForAll-NCMX4LGZ.js"),
        import("./setApprovalForAll-TGBNXHRW.js")
      ]);
      ...
      const [{ isApprovedForAll }, { setApprovalForAll }, { getApproved }] = await Promise.all([
        import("./isApprovedForAll-TUBMYXBD.js"),
        import("./setApprovalForAll-X56P36GD.js"),
        import("./getApproved-2PUEJEAH.js")
      ]);
...
async function getPayMetadata3(options) {
  ...
  const [{ getContractMetadata: getContractMetadata2 }, { getNFT: getERC721 }, { getNFT: getERC1155 }] = await Promise.all([
    import("./getContractMetadata-OYGR57BC.js"),
    import("./getNFT-C3BBCRH3.js"),
    import("./getNFT-EDA6QVSI.js")
  ]);
