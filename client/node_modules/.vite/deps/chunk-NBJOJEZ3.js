  ...
  "node_modules/bn.js/lib/bn.js"(exports, module) {
    (function(module2, exports2) {
      ...
      Mont.prototype.mul = function mul(a4, b4) {
        if (a4.isZero() || b4.isZero()) return new BN(0)._forceRed(this);
        var t = a4.mul(b4);
        var c5 = t.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m);
        var u3 = t.isub(c5).iushrn(this.shift);
        var res = u3;
...
var Sn = (e2, t) => {
  for (var r3 in t || (t = {})) Wo.call(t, r3) && En(e2, r3, t[r3]);
  if (Mn) for (var r3 of Mn(t)) Xo.call(t, r3) && En(e2, r3, t[r3]);
  return e2;
};
var In = "ReactNative";
...
async function ys({ id: e2, topic: t, wcDeepLink: r3 }) {
  ...
  try {
    ...
    } else p3 === qt.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(h5);
  } catch (n5) {
    console.error(n5);
  }
}
...
(function(e2) {
  (function() {
    ...
    }, b4 = [{ name: "keccak", padding: S4, bits: T3, createMethod: Rt2 }, { name: "sha3", padding: N10, bits: T3, createMethod: Rt2 }, { name: "shake", padding: w4, bits: U3, createMethod: Vt2 }, { name: "cshake", padding: y6, bits: U3, createMethod: Y }, { name: "kmac", padding: y6, bits: U3, createMethod: Wt2 }], f4 = {}, a4 = [], c5 = 0; c5 < b4.length; ++c5) for (var d3 = b4[c5], m2 = d3.bits, x5 = 0; x5 < m2.length; ++x5) {
    ...
    s3.prototype.update = function(u3) {
      ...
      if (E3) B3 = R2;
      else for (var F2 = 0; F2 < u3.length; ++F2) {
      ...
      for (var _3 = this.encode(E3), B3 = 0; B3 < u3.length; ++B3) _3 += this.encodeString(u3[B3]);
      var R2 = E3 - _3 % E3, F2 = [];
      ...
      if (!this.finalized) {
        ...
        if (u3[E3 >> 2] |= this.padding[E3 & 3], this.lastByteIndex === this.byteCount) for (u3[0] = u3[_3], E3 = 1; E3 < _3 + 1; ++E3) u3[E3] = 0;
        for (u3[_3 - 1] |= 2147483648, E3 = 0; E3 < _3; ++E3) B3[E3] ^= u3[E3];
        k3(B3);
      }
      ...
      for (var u3 = this.blockCount, E3 = this.s, _3 = this.outputBlocks, B3 = this.extraBytes, R2 = 0, F2 = 0, P2 = "", O4; F2 < _3; ) {
        for (R2 = 0; R2 < u3 && F2 < _3; ++R2, ++F2) O4 = E3[R2], P2 += v4[O4 >> 4 & 15] + v4[O4 & 15] + v4[O4 >> 12 & 15] + v4[O4 >> 8 & 15] + v4[O4 >> 20 & 15] + v4[O4 >> 16 & 15] + v4[O4 >> 28 & 15] + v4[O4 >> 24 & 15];
        F2 % u3 === 0 && (k3(E3), R2 = 0);
      }
      ...
      for (var Ct2 = new Uint32Array(O4); F2 < _3; ) {
        for (R2 = 0; R2 < u3 && F2 < _3; ++R2, ++F2) Ct2[F2] = E3[R2];
        F2 % u3 === 0 && k3(E3);
      }
      ...
      for (var u3 = this.blockCount, E3 = this.s, _3 = this.outputBlocks, B3 = this.extraBytes, R2 = 0, F2 = 0, P2 = [], O4, Ct2; F2 < _3; ) {
        for (R2 = 0; R2 < u3 && F2 < _3; ++R2, ++F2) O4 = F2 << 2, Ct2 = E3[R2], P2[O4] = Ct2 & 255, P2[O4 + 1] = Ct2 >> 8 & 255, P2[O4 + 2] = Ct2 >> 16 & 255, P2[O4 + 3] = Ct2 >> 24 & 255;
        F2 % u3 === 0 && k3(E3);
      }
...
var z = class _z {
  ...
  makeError(t, r3, i4) {
    if (qn) return this.makeError("censored error", r3, {});
    ...
    Object.keys(i4).forEach((A3) => {
      ...
      try {
        if (v4 instanceof Uint8Array) {
          let w4 = "";
          for (let y6 = 0; y6 < v4.length; y6++) w4 += Ln[v4[y6] >> 4], w4 += Ln[v4[y6] & 15];
          n5.push(A3 + "=Uint8Array(0x" + w4 + ")");
        } else n5.push(A3 + "=" + JSON.stringify(v4));
      } catch {
...
function nr(e2) {
  ...
  for (let t = 0; t < e2.length; t++) {
    const r3 = e2[t];
    if (!jn(r3) || r3 < 0 || r3 >= 256) return false;
  }
  return true;
}
function Ot(e2, t) {
...
function Kt(e2, t) {
  if (t || (t = {}), typeof e2 == "number") {
    ...
    let r3 = "";
    for (; e2; ) r3 = Ei[e2 & 15] + r3, e2 = Math.floor(e2 / 16);
  ...
  if (Jt(e2)) return e2.length % 2 && (t.hexPad === "left" ? e2 = "0x0" + e2.substring(2) : t.hexPad === "right" ? e2 += "0" : Dt.throwArgumentError("hex data is odd-length", "value", e2)), e2.toLowerCase();
  if (nr(e2)) {
    let r3 = "0x";
...
function oe(e2, t) {
  for (typeof e2 != "string" ? e2 = Kt(e2) : Jt(e2) || Dt.throwArgumentError("invalid hex string", "value", e2), e2.length > 2 * t + 2 && Dt.throwArgumentError("value out of range", "value", arguments[1]); e2.length < 2 * t + 2; ) e2 = "0x0" + e2.substring(2);
  return e2;
}
function Jn(e2) {
...
(function(e2) {
  (function(t, r3) {
    function i4(b4, f4) {
      if (!b4) throw new Error(f4 || "Assertion failed");
    }
    function n5(b4, f4) {
      b4.super_ = f4;
      var a4 = function() {
    ...
    o4.isBN = function(f4) {
      ...
      var m2, x5, M2 = 0;
      if (c5 === "be") for (d3 = f4.length - 1, m2 = 0; d3 >= 0; d3 -= 3) x5 = f4[d3] | f4[d3 - 1] << 8 | f4[d3 - 2] << 16, this.words[m2] |= x5 << M2 & 67108863, this.words[m2 + 1] = x5 >>> 26 - M2 & 67108863, M2 += 24, M2 >= 26 && (M2 -= 26, m2++);
      else if (c5 === "le") for (d3 = 0, m2 = 0; d3 < f4.length; d3 += 3) x5 = f4[d3] | f4[d3 + 1] << 8 | f4[d3 + 2] << 16, this.words[m2] |= x5 << M2 & 67108863, this.words[m2 + 1] = x5 >>> 26 - M2 & 67108863, M2 += 24, M2 >= 26 && (M2 -= 26, m2++);
      return this._strip();
    };
    function p3(b4, f4) {
    ...
    o4.prototype._parseHex = function(f4, a4, c5) {
      ...
      for (var d3 = 0; d3 < this.length; d3++) this.words[d3] = 0;
      var m2 = 0, x5 = 0, M2;
      if (c5 === "be") for (d3 = f4.length - 1; d3 >= a4; d3 -= 2) M2 = A3(f4, a4, d3) << m2, this.words[x5] |= M2 & 67108863, m2 >= 18 ? (m2 -= 18, x5 += 1, this.words[x5] |= M2 >>> 26) : m2 += 8;
      else {
        var l4 = f4.length - a4;
        for (d3 = l4 % 2 === 0 ? a4 + 1 : a4; d3 < f4.length; d3 += 2) M2 = A3(f4, a4, d3) << m2, this.words[x5] |= M2 & 67108863, m2 >= 18 ? (m2 -= 18, x5 += 1, this.words[x5] |= M2 >>> 26) : m2 += 8;
      }
      this._strip();
    };
    ...
    o4.prototype._parseBase = function(f4, a4, c5) {
      ...
      for (var d3 = 0, m2 = 1; m2 <= 67108863; m2 *= a4) d3++;
      d3--, m2 = m2 / a4 | 0;
      for (var x5 = f4.length - c5, M2 = x5 % d3, l4 = Math.min(x5, x5 - M2) + c5, s3 = 0, g3 = c5; g3 < l4; g3 += d3) s3 = v4(f4, g3, g3 + d3, a4), this.imuln(m2), this.words[0] + s3 < 67108864 ? this.words[0] += s3 : this._iaddn(s3);
      if (M2 !== 0) {
        var k3 = 1;
        for (s3 = v4(f4, g3, f4.length, a4), g3 = 0; g3 < M2; g3++) k3 *= a4;
    ...
    o4.prototype.toString = function(f4, a4) {
      ...
      if (f4 === 16 || f4 === "hex") {
        ...
        for (m2 !== 0 && (c5 = m2.toString(16) + c5); c5.length % a4 !== 0; ) c5 = "0" + c5;
    ...
    o4.prototype.zeroBits = function() {
      ...
      for (var m2 = 0, x5 = 0; x5 < d3.length; x5++) a4 = (c5.words[x5] | 0) + (d3.words[x5] | 0) + m2, this.words[x5] = a4 & 67108863, m2 = a4 >>> 26;
      for (; m2 !== 0 && x5 < c5.length; x5++) a4 = (c5.words[x5] | 0) + m2, this.words[x5] = a4 & 67108863, m2 = a4 >>> 26;
      if (this.length = c5.length, m2 !== 0) this.words[this.length] = m2, this.length++;
      ...
      for (var x5 = 0, M2 = 0; M2 < m2.length; M2++) a4 = (d3.words[M2] | 0) - (m2.words[M2] | 0) + x5, x5 = a4 >> 26, this.words[M2] = a4 & 67108863;
      for (; x5 !== 0 && M2 < d3.length; M2++) a4 = (d3.words[M2] | 0) + x5, x5 = a4 >> 26, this.words[M2] = a4 & 67108863;
      if (x5 === 0 && M2 < d3.length && d3 !== this) for (; M2 < d3.length; M2++) this.words[M2] = d3.words[M2];
    ...
    o4.prototype.mulTo = function(f4, a4) {
      ...
      if (++d3 < a4.length) for (var m2 = c5.sqr(); d3 < a4.length; d3++, m2 = m2.sqr()) a4[d3] !== 0 && (c5 = c5.mul(m2));
      return c5;
      ...
      if (c5 !== 0) {
        for (m2 = this.length - 1; m2 >= 0; m2--) this.words[m2 + c5] = this.words[m2];
        for (m2 = 0; m2 < c5; m2++) this.words[m2] = 0;
        this.length += c5;
      }
      return this._strip();
      ...
      for (; m2 < this.length - c5; m2++) x5 = (this.words[m2 + c5] | 0) + M2, M2 = x5 >> 26, this.words[m2 + c5] = x5 & 67108863;
      if (M2 === 0) return this._strip();
      for (i4(M2 === -1), M2 = 0, m2 = 0; m2 < this.length; m2++) x5 = -(this.words[m2] | 0) + M2, M2 = x5 >> 26, this.words[m2] = x5 & 67108863;
      ...
      if (a4 !== "mod") {
        ...
        for (var g3 = 0; g3 < s3.length; g3++) s3.words[g3] = 0;
      }
      ...
      for (var u3 = l4 - 1; u3 >= 0; u3--) {
        ...
        for (E3 = Math.min(E3 / x5 | 0, 67108863), d3._ishlnsubmul(m2, E3, u3); d3.negative !== 0; ) E3--, d3.negative = 0, d3._ishlnsubmul(m2, 1, u3), d3.isZero() || (d3.negative ^= 1);
        s3 && (s3.words[u3] = E3);
      }
      ...
      for (var c5 = (1 << 26) % f4, d3 = 0, m2 = this.length - 1; m2 >= 0; m2--) d3 = (c5 * d3 + (this.words[m2] | 0)) % f4;
      return a4 ? -d3 : d3;
      ...
      for (var d3 = new o4(1), m2 = new o4(0), x5 = new o4(0), M2 = new o4(1), l4 = 0; a4.isEven() && c5.isEven(); ) a4.iushrn(1), c5.iushrn(1), ++l4;
      for (var s3 = c5.clone(), g3 = a4.clone(); !a4.isZero(); ) {
        for (var k3 = 0, u3 = 1; !(a4.words[0] & u3) && k3 < 26; ++k3, u3 <<= 1) ;
        if (k3 > 0) for (a4.iushrn(k3); k3-- > 0; ) (d3.isOdd() || m2.isOdd()) && (d3.iadd(s3), m2.isub(g3)), d3.iushrn(1), m2.iushrn(1);
        for (var E3 = 0, _3 = 1; !(c5.words[0] & _3) && E3 < 26; ++E3, _3 <<= 1) ;
        if (E3 > 0) for (c5.iushrn(E3); E3-- > 0; ) (x5.isOdd() || M2.isOdd()) && (x5.iadd(s3), M2.isub(g3)), x5.iushrn(1), M2.iushrn(1);
      ...
      for (var d3 = new o4(1), m2 = new o4(0), x5 = c5.clone(); a4.cmpn(1) > 0 && c5.cmpn(1) > 0; ) {
        ...
        if (M2 > 0) for (a4.iushrn(M2); M2-- > 0; ) d3.isOdd() && d3.iadd(x5), d3.iushrn(1);
        for (var s3 = 0, g3 = 1; !(c5.words[0] & g3) && s3 < 26; ++s3, g3 <<= 1) ;
        if (s3 > 0) for (c5.iushrn(s3); s3-- > 0; ) m2.isOdd() && m2.iadd(x5), m2.iushrn(1);
      ...
      do {
        ...
        if (m2 < 0) {
          var x5 = a4;
          a4 = c5, c5 = x5;
        } else if (m2 === 0 || c5.cmpn(1) === 0) break;
        a4.isub(c5);
      } while (true);
      return c5.iushln(d3);
    ...
    n5(Pt2, L2), Pt2.prototype.split = function(f4, a4) {
      for (var c5 = 4194303, d3 = Math.min(f4.length, 9), m2 = 0; m2 < d3; m2++) a4.words[m2] = f4.words[m2];
    ...
    n5(Vt2, L2), Vt2.prototype.imulK = function(f4) {
      ...
      else if (f4 === "p224") a4 = new W();
      else if (f4 === "p192") a4 = new Rt2();
      else if (f4 === "p25519") a4 = new Vt2();
    ...
    function Y(b4) {
      ...
      } else i4(b4.gtn(1), "modulus must be greater than 1"), this.m = b4, this.prime = null;
    }
    Y.prototype._verify1 = function(f4) {
      ...
      for (var d3 = this.m.subn(1), m2 = 0; !d3.isZero() && d3.andln(1) === 0; ) m2++, d3.iushrn(1);
      i4(!d3.isZero());
      var x5 = new o4(1).toRed(this), M2 = x5.redNeg(), l4 = this.m.subn(1).iushrn(1), s3 = this.m.bitLength();
      for (s3 = new o4(2 * s3 * s3).toRed(this); this.pow(s3, l4).cmp(M2) !== 0; ) s3.redIAdd(M2);
      ...
      for (var m2 = 2; m2 < d3.length; m2++) d3[m2] = this.mul(d3[m2 - 1], f4);
...
var V = class _V {
  ...
  static from(t) {
    ...
    if (typeof t == "string") return t.match(/^-?0x[0-9a-f]+$/i) ? new _V(Ii, mr(t)) : t.match(/^-?[0-9]+$/) ? new _V(Ii, mr(new Tr(t))) : Ae.throwArgumentError("invalid BigNumber string", "value", t);
    ...
    if (r3) if (r3.toHexString) {
      ...
      let i4 = r3._hex;
      if (i4 == null && r3.type === "BigNumber" && (i4 = r3.hex), typeof i4 == "string" && (Jt(i4) || i4[0] === "-" && Jt(i4.substring(1)))) return _V.from(i4);
    }
...
function be(e2, t) {
  ...
  for (h5.length > r3.length - 1 && $n("fractional component exceeds decimals", "underflow", "parseFixed"), h5 === "" && (h5 = "0"); h5.length < r3.length - 1; ) h5 += "0";
...
function Js(e2) {
  ...
  for (let H2 = 1; H2 < i4; H2++) o4.push(n5 += r3());
  let h5 = r3(), p3 = t;
  t += h5;
  let A3 = 0, v4 = 0;
  function w4() {
  ...
  let T3 = 0;
  for (let H2 = 0; H2 < y6; H2++) T3 = T3 << 1 | w4();
  let U3 = [], J = 0, Bt2 = S4;
  for (; ; ) {
    ...
    for (; !((W ^ Rt2) & N10); ) T3 = T3 << 1 & C4 | w4(), W = W << 1 & C4, Rt2 = Rt2 << 1 & C4 | 1;
    for (; W & ~Rt2 & I4; ) T3 = T3 & N10 | T3 << 1 & C4 >>> 1 | w4(), W = W << 1 ^ N10, Rt2 = (Rt2 ^ N10) << 1 | N10 | 1;
    J = W, Bt2 = 1 + Rt2 - W;
  }
  let G = i4 - 4;
  return U3.map((H2) => {
...
function Xs(e2, t) {
  let r3 = Array(e2);
  for (let i4 = 0, n5 = 0; i4 < e2; i4++) r3[i4] = n5 += Vs(t());
  return r3;
}
function Ur(e2, t) {
...
function af(e2, t, r3) {
  ...
  for (let n5 = 0; n5 < t; n5++) Xs(e2, r3).forEach((o4, h5) => i4[h5].push(o4));
  return i4;
}
function t0(e2, t) {
...
function c0(e2) {
  let t = null;
  if (typeof e2 != "string" && yr.throwArgumentError("invalid address", "address", e2), e2.match(/^(0x)?[0-9a-fA-F]{40}$/)) e2.substring(0, 2) !== "0x" && (e2 = "0x" + e2), t = hf(e2), e2.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && t !== e2 && yr.throwArgumentError("bad address checksum", "address", e2);
  else if (e2.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
    for (e2.substring(2, 4) !== h0(e2) && yr.throwArgumentError("bad icap checksum", "address", e2), t = ks(e2.substring(4)); t.length < 40; ) t = "0" + t;
    t = hf("0x" + t);
...
Q.toArray = b0;
function y0(e2) {
  for (var t = "", r3 = 0; r3 < e2.length; r3++) t += pf(e2[r3].toString(16));
  return t;
}
Q.toHex = y0;
function df(e2) {
...
function z0(e2, t, r3, i4) {
  if (e2 === 0) return mf(t, r3, i4);
  if (e2 === 1 || e2 === 3) return bf(t, r3, i4);
  if (e2 === 2) return Af(t, r3, i4);
}
ae.ft_1 = z0;
function mf(e2, t, r3) {
  return e2 & t ^ ~e2 & r3;
...
he.blockSize = 512, he.outSize = 160, he.hmacStrength = 80, he.padLength = 64, he.prototype._update = function(t, r3) {
  ...
  for (; n5 < i4.length; n5++) i4[n5] = Pi(i4[n5 - 3] ^ i4[n5 - 8] ^ i4[n5 - 14] ^ i4[n5 - 16], 1);
...
ce.blockSize = 512, ce.outSize = 256, ce.hmacStrength = 192, ce.padLength = 64, ce.prototype._update = function(t, r3) {
  for (var i4 = this.W, n5 = 0; n5 < 16; n5++) i4[n5] = t[r3 + n5];
  for (; n5 < i4.length; n5++) i4[n5] = ra(ua(i4[n5 - 2]), i4[n5 - 7], aa(i4[n5 - 15]), i4[n5 - 16]);
...
var fe = lr(function(e2, t) {
  ...
  function i4(h5, p3) {
    ...
    var A3 = [];
    if (typeof h5 != "string") {
      for (var v4 = 0; v4 < h5.length; v4++) A3[v4] = h5[v4] | 0;
      return A3;
    }
    if (p3 === "hex") {
      h5 = h5.replace(/[^a-z0-9]+/ig, ""), h5.length % 2 !== 0 && (h5 = "0" + h5);
      for (var v4 = 0; v4 < h5.length; v4 += 2) A3.push(parseInt(h5[v4] + h5[v4 + 1], 16));
    } else for (var v4 = 0; v4 < h5.length; v4++) {
...
Ce.prototype.point = function() {
  ...
  for (p3 = 0; p3 < n5.length; p3 += i4.step) {
    A3 = 0;
    for (var v4 = p3 + i4.step - 1; v4 >= p3; v4--) A3 = (A3 << 1) + n5[v4];
    h5.push(A3);
  }
  for (var w4 = this.jpoint(null, null, null), y6 = this.jpoint(null, null, null), S4 = o4; S4 > 0; S4--) {
    for (p3 = 0; p3 < h5.length; p3++) A3 = h5[p3], A3 === S4 ? y6 = y6.mixedAdd(i4.points[p3]) : A3 === -S4 && (y6 = y6.mixedAdd(i4.points[p3].neg()));
    w4 = w4.add(y6);
  }
  return w4.toP();
  ...
  for (var o4 = n5.points, h5 = Hr(r3, i4, this._bitLength), p3 = this.jpoint(null, null, null), A3 = h5.length - 1; A3 >= 0; A3--) {
    for (var v4 = 0; A3 >= 0 && h5[A3] === 0; A3--) v4++;
    if (A3 >= 0 && v4++, p3 = p3.dblp(v4), A3 < 0) break;
    var w4 = h5[A3];
  ...
  for (w4 = v4; w4 >= 0; w4--) {
    for (var Pt2 = 0; w4 >= 0; ) {
      var W = true;
      for (y6 = 0; y6 < n5; y6++) L2[y6] = A3[y6][w4] | 0, L2[y6] !== 0 && (W = false);
      if (!W) break;
      Pt2++, w4--;
    }
    if (w4 >= 0 && Pt2++, H2 = H2.dblp(Pt2), w4 < 0) break;
    for (y6 = 0; y6 < n5; y6++) {
      var Rt2 = L2[y6];
...
te.prototype._getEndomorphism = function(t) {
  ...
  for (var r3 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i4 = t, n5 = this.n.clone(), o4 = new K(1), h5 = new K(0), p3 = new K(0), A3 = new K(1), v4, w4, y6, S4, N10, I4, C4, T3 = 0, U3, J; i4.cmpn(0) !== 0; ) {
    ...
    if (!y6 && U3.cmp(r3) < 0) v4 = C4.neg(), w4 = o4, y6 = U3.neg(), S4 = J;
    else if (y6 && ++T3 === 2) break;
...
qi(Ft, Ze.BasePoint), te.prototype.jpoint = function(t, r3, i4) {
  ...
  if (A3.cmpn(0) === 0) return v4.cmpn(0) !== 0 ? this.curve.jpoint(null, null, null) : this.dbl();
...
Qr.prototype.toDER = function(t) {
  ...
  for (r3[0] & 128 && (r3 = [0].concat(r3)), i4[0] & 128 && (i4 = [0].concat(i4)), r3 = Ff(r3), i4 = Ff(i4); !i4[0] && !(i4[1] & 128); ) i4 = i4.slice(1);
  var n5 = [2];
...
ee.prototype.keyPair = function(t) {
  ...
  if (h5.cmp(this.curve.p.umod(this.curve.n)) >= 0 && v4) throw new Error("Unable to find sencond key candinate");
...
var Ji = (e2, t) => {
  for (var r3 in t || (t = {})) uu.call(t, r3) && jf(e2, r3, t[r3]);
  if (zf) for (var r3 of zf(t)) hu.call(t, r3) && jf(e2, r3, t[r3]);
  return e2;
};
...
var Gi = (e2) => {
  const t = e2 && Gr(e2);
  if (t) return e2.includes(cu) ? t[3] : t[1];
};
var lu = (e2) => {
  const t = e2 && Gr(e2);
  if (t) return t[2] + ":" + t[3];
...
function Bu(e2) {
  ...
  if ($e(t) === pr && typeof e2.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
...
function nn(e2) {
  ...
  if ($e(e2.type) === Sr) return toString2(concat([e2.type, e2.sealed]), t);
  if ($e(e2.type) === pr) {
...
function ku(e2, t) {
  ...
  if (!w4.verify(y6, { r: h5, s: p3 })) throw new Error("Invalid signature");
...
var ao = (e2, t) => {
  for (var r3 in t || (t = {})) ju.call(t, r3) && so(e2, r3, t[r3]);
  if (oo) for (var r3 of oo(t)) Qu.call(t, r3) && so(e2, r3, t[r3]);
  return e2;
};
...
function fh(e2, t) {
  ...
  const r3 = bo(t);
  for (const [i4, n5] of Object.entries(r3)) n5.methods ? n5.methods = me(n5.methods, e2) : n5.methods = e2, n5.events = ["chainChanged", "accountsChanged"];
  return r3;
}
...
function xs2(o4, e2) {
  ...
  function g3(l4) {
    ...
    for (var p3 = 0, _3 = 0, D3 = 0, E3 = l4.length; D3 !== E3 && l4[D3] === 0; ) D3++, p3++;
    for (var N10 = (E3 - D3) * d3 + 1 >>> 0, C4 = new Uint8Array(N10); D3 !== E3; ) {
      for (var L2 = l4[D3], k3 = 0, x5 = N10 - 1; (L2 !== 0 || k3 < _3) && x5 !== -1; x5--, k3++) L2 += 256 * C4[x5] >>> 0, C4[x5] = L2 % a4 >>> 0, L2 = L2 / a4 >>> 0;
      if (L2 !== 0) throw new Error("Non-zero carry");
      _3 = k3, D3++;
    }
    for (var M2 = N10 - _3; M2 !== N10 && C4[M2] === 0; ) M2++;
    for (var ie2 = c5.repeat(p3); M2 < N10; ++M2) ie2 += o4.charAt(C4[M2]);
    return ie2;
  }
  function m2(l4) {
    ...
    var p3 = 0;
    if (l4[p3] !== " ") {
      for (var _3 = 0, D3 = 0; l4[p3] === c5; ) _3++, p3++;
      for (var E3 = (l4.length - p3) * h5 + 1 >>> 0, N10 = new Uint8Array(E3); l4[p3]; ) {
        var C4 = t[l4.charCodeAt(p3)];
        if (C4 === 255) return;
        for (var L2 = 0, k3 = E3 - 1; (C4 !== 0 || L2 < D3) && k3 !== -1; k3--, L2++) C4 += a4 * N10[k3] >>> 0, N10[k3] = C4 % 256 >>> 0, C4 = C4 / 256 >>> 0;
        if (C4 !== 0) throw new Error("Non-zero carry");
        D3 = L2, p3++;
      }
      if (l4[p3] !== " ") {
        for (var x5 = E3 - D3; x5 !== E3 && N10[x5] === 0; ) x5++;
        for (var M2 = new Uint8Array(_3 + (E3 - x5)), ie2 = _3; x5 !== E3; ) M2[ie2++] = N10[x5++];
        return M2;
      }
    }
  }
...
var Us2 = (o4, e2, t) => {
  ...
  let r3 = "", n5 = 0, a4 = 0;
  for (let c5 = 0; c5 < o4.length; ++c5) for (a4 = a4 << 8 | o4[c5], n5 += 8; n5 > t; ) n5 -= t, r3 += e2[i4 & a4 >> n5];
...
function Mt(o4, e2, t) {
  e2 = e2 || [], t = t || 0;
  for (var s3 = t; o4 >= Pr; ) e2[t++] = o4 & 255 | zt2, o4 /= 128;
  for (; o4 & Sr2; ) e2[t++] = o4 & 255 | zt2, o4 >>>= 7;
...
var Jt2 = class {
  constructor(e2, t, s3) {
    this.core = e2, this.logger = t, this.name = Ze2, this.randomSessionIdentifier = Su(), this.initialized = false, this.init = async () => {
      ...
      if (Tu(a4)) return Cu(c5, n5 == null ? void 0 : n5.encoding);
      if (Du(a4)) {
  ...
  constructor(e2, t) {
    super(e2, t), this.relayer = e2, this.logger = t, this.events = new import_events7.EventEmitter(), this.name = nt, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time4.toMiliseconds)(import_time4.ONE_MINUTE), this.failedPublishTimeout = (0, import_time4.toMiliseconds)(import_time4.ONE_SECOND), this.needsTransportRestart = false, this.publish = async (s3, i4, r3) => {
      ...
      try {
        ...
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(D3), (n5 = r3 == null ? void 0 : r3.internal) != null && n5.throwOnFailedPublish) throw D3;
...
var ee2 = (o4, e2) => {
  for (var t in e2 || (e2 = {})) on.call(e2, t) && Zt2(o4, t, e2[t]);
  if (Xt) for (var t of Xt(e2)) an2.call(e2, t) && Zt2(o4, t, e2[t]);
  return o4;
};
...
var un2 = (o4, e2) => {
  for (var t in e2 || (e2 = {})) hn2.call(e2, t) && ti(o4, t, e2[t]);
  if (ei) for (var t of ei(e2)) ln2.call(e2, t) && ti(o4, t, e2[t]);
  return o4;
};
var ii = class extends u {
  ...
  async onProviderPayload(e2) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e2 }), isJsonRpcRequest(e2)) {
      if (!e2.method.endsWith(ht)) return;
...
var ni = (o4, e2) => {
  for (var t in e2 || (e2 = {})) gn2.call(e2, t) && ri(o4, t, e2[t]);
  if (si) for (var t of si(e2)) pn2.call(e2, t) && ri(o4, t, e2[t]);
  return o4;
};
...
var ai = class {
  constructor(e2, t) {
    this.core = e2, this.logger = t, this.name = Dt2, this.version = mt, this.events = new import_events7.default(), this.initialized = false, this.storagePrefix = O3, this.ignoredPayloadTypes = [pr], this.registeredMethods = [], this.init = async () => {
      ...
      if (this.pairings.keys.includes(r3)) {
        if (d3 = this.pairings.get(r3), i4.addTrace(z4.existing_pairing), d3.active) throw i4.setError($.active_pairing_already_exists), new Error(`Pairing already exists: ${r3}. Please try again with a new connection URI.`);
  ...
  registerRelayerEvents() {
    this.core.relayer.on(w3.message, async (e2) => {
      ...
      if (!this.pairings.keys.includes(t) || i4 === F.link_mode || this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(s3))) return;
        ...
        const h5 = li(), d3 = this.startAbortTimer(import_time4.ONE_SECOND * 5), g3 = await new Promise((m2, b4) => {
          ...
          const _3 = (D3) => {
            ...
            if (E3.type === "verify_attestation") {
              if (decodeJWT(E3.attestation).payload.id !== n5) return;
...
var te2 = (o4, e2) => {
  for (var t in e2 || (e2 = {})) Cn2.call(e2, t) && pi2(o4, t, e2[t]);
  if (gi) for (var t of gi(e2)) Sn2.call(e2, t) && pi2(o4, t, e2[t]);
  return o4;
};
...
var bi2 = (o4, e2) => {
  for (var t in e2 || (e2 = {})) Rn2.call(e2, t) && mi(o4, t, e2[t]);
  if (Di2) for (var t of Di2(e2)) xn.call(e2, t) && mi(o4, t, e2[t]);
  return o4;
};
...
var I3 = (q2, o4) => {
  for (var e2 in o4 || (o4 = {})) _s2.call(o4, e2) && gt2(q2, e2, o4[e2]);
  if (ut2) for (var e2 of ut2(o4)) Es2.call(o4, e2) && gt2(q2, e2, o4[e2]);
  return q2;
};
  ...
  constructor(o4) {
    super(o4), this.name = nt2, this.events = new import_events8.default(), this.initialized = false, this.requestQueue = { state: x4.idle, queue: [] }, this.sessionRequestQueue = { state: x4.idle, queue: [] }, this.requestQueueDelay = import_time5.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.relayMessageCache = [], this.init = async () => {
      ...
      const M2 = y6 && y6 > v3.wc_sessionAuthenticate.req.ttl ? y6 : v3.wc_sessionAuthenticate.req.ttl, W = { authPayload: { type: d3 ?? "caip122", chains: n5, statement: a4, aud: c5, domain: h5, version: "1", nonce: p3, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: l4, nbf: w4, resources: _3 }, requester: { publicKey: E3, metadata: this.client.metadata }, expiryTimestamp: ms(M2) }, N10 = { eip155: { chains: n5, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...m2])], events: ["chainChanged", "accountsChanged"] } }, De = { requiredNamespaces: {}, optionalNamespaces: N10, relays: [{ protocol: "irn" }], pairingTopic: R2, proposer: { publicKey: E3, metadata: this.client.metadata }, expiryTimestamp: ms(v3.wc_sessionPropose.req.ttl) }, { done: wt2, resolve: Ve, reject: Ee2 } = ls(M2, "Request expired"), ce3 = async ({ error: O4, session: T3 }) => {
        if (this.events.off(bs("session_request", G), Re3), O4) Ee2(O4);
        else if (T3) {
      ...
      try {
        if (i4) {
          ...
          Se = Vu(t, R2, T3);
        } else await Promise.all([this.sendRequest({ topic: R2, method: "wc_sessionAuthenticate", params: W, expiry: e2.expiry, throwOnFailedPublish: true, clientRpcId: G }), this.sendRequest({ topic: R2, method: "wc_sessionPropose", params: De, expiry: v3.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: Z2 })]);
      } catch (O4) {
      ...
      if (!r3) throw i4.setError(Rs2.authenticated_session_pending_request_not_found), new Error(`Could not find pending auth request with id ${t}`);
      ...
      for (const y6 of s3) {
        ...
        for (const S4 of V2) l4.push(`${S4}:${E3}`);
      }
      ...
      if (!ph(e2)) throw new Error(xe("MISSING_OR_INVALID", `approve() params: ${e2}`).message);
      ...
      if (!Yt(s3, false)) throw new Error("uri is required parameter");
      if (!Yt(i4, false)) throw new Error("domain is required parameter");
...
@walletconnect/utils/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-NBJOJEZ3.js.map
