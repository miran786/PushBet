      ...
      const wallet = {
        ...
        autoConnect: async (options) => {
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-XMVMG3V2.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-XMVMG3V2.js");
...
//# sourceMappingURL=chunk-TYCBL2ZK.js.map
