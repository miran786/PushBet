...
async function sendTransaction(options) {
  ...
  if (options.transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-FHUX6GKY.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-UZPERYJG.js");
...
//# sourceMappingURL=chunk-XCLLFXXN.js.map
