...
} from "./chunk-MHIQAK6A.js";
import {
  EcosystemWalletConnectUI_default
} from "./chunk-7MEI5NPB.js";
import {
  AccentFailIcon,
  AnyWalletConnectUI,
  PoweredByThirdweb,
...
import {
  decimals
} from "./chunk-N7RQUMCX.js";
import {
  COINBASE
} from "./chunk-LZH3KM55.js";
import {
  socialAuthOptions
} from "./chunk-UHYTXJZX.js";
import {
  webLocalStorage
} from "./chunk-57DFWRZ3.js";
import {
  isContractDeployed
} from "./chunk-OGP6JCES.js";
import {
...
import {
  polygon
} from "./chunk-LN5L3RMI.js";
import {
  ethereum
} from "./chunk-J75GJCYK.js";
import {
  cacheChains,
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-S7RSPYZ7.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-HALR5GW3.js"),
              import("./in-app-core-N6ZPMDQI.js")
            ]);
...
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-SNFRWTTA.js"));
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react38.lazy)(() => import("./AllWalletsUI-VQFWSMN4.js"));
...
var InAppWalletConnectUI = (0, import_react40.lazy)(() => import("./InAppWalletConnectUI-44IYZCWR.js"));
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-SD7S2YJ7.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-4IR26XBJ.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-FELIFG6Q.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-W7MOUPXG.js");
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-S55H6HT4.js");
...
//# sourceMappingURL=chunk-EMLAORUT.js.map
