    ...
    switch (request.method) {
      case "personal_sign": {
        if (handlers == null ? void 0 : handlers.personal_sign) {
          ...
          const { handleSignRequest } = await import("./sign-DXMEITT7.js");
      ...
      case "eth_signTypedData": {
        if (handlers == null ? void 0 : handlers.eth_signTypedData) {
          ...
          const { handleSignTypedDataRequest } = await import("./sign-typed-data-UFIYIYK6.js");
      ...
      case "eth_signTransaction": {
        if (handlers == null ? void 0 : handlers.eth_signTransaction) {
          ...
          const { handleSignTransactionRequest } = await import("./sign-transaction-HXSFH3BG.js");
      ...
      case "eth_sendTransaction": {
        ...
        if (handlers == null ? void 0 : handlers.eth_sendTransaction) {
          ...
          const { handleSendTransactionRequest } = await import("./send-transaction-O66IDDWI.js");
      ...
      case "wallet_switchEthereumChain": {
        if (handlers == null ? void 0 : handlers.wallet_switchEthereumChain) {
          ...
          const { handleSwitchChain } = await import("./switch-chain-4NKXUCKN.js");
...
//# sourceMappingURL=session-request-4WTFMX3H.js.map
