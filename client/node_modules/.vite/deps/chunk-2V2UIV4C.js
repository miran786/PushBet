...
} from "./chunk-ITKS5SBE.js";
import {
  EcosystemWalletConnectUI_default
} from "./chunk-QRN2Z2ZC.js";
import {
  AccentFailIcon,
  AnyWalletConnectUI,
  PoweredByThirdweb,
...
import {
  getCurrencyMetadata
} from "./chunk-MVHHHY3K.js";
import {
  smartWallet
} from "./chunk-5FUMGZVL.js";
import {
  isInAppWallet
...
import {
  isContractDeployed
} from "./chunk-WXKNGXC4.js";
import {
  decimals
} from "./chunk-CR76DAZE.js";
import {
...
import {
  polygon
} from "./chunk-UTGZ7V7T.js";
import {
  ethereum
} from "./chunk-HMYENUZY.js";
import {
  cacheChains,
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-HRQKI7UN.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-4JEBC6FN.js"),
              import("./in-app-core-IUUZPTDJ.js")
            ]);
...
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-TMB34ESQ.js"));
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react38.lazy)(() => import("./AllWalletsUI-63EJZJ5G.js"));
...
var InAppWalletConnectUI = (0, import_react40.lazy)(() => import("./InAppWalletConnectUI-AIPFVD2K.js"));
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-EFNTICYO.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-EDPOFXTG.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-L356BEWG.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-56T4AE2E.js");
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-GBDAVD6R.js");
...
//# sourceMappingURL=chunk-2V2UIV4C.js.map
